        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @can('level')
                    <p>
                        <a href="{{ route('cliente.index') }}" class="bg-green-500 text-white rounded p-2">Lista de Clientes</a>
                    </p>
                    @endcan

                    <p class="mb-2 p-6 px-0">
                        <a href="{{ route('meus.clientes', Auth::user()->id) }}" class="bg-gray-500 text-white rounded p-2 px-4">Meus Clientes</a>                        
                    </p>
